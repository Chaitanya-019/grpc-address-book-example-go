...
func PromptForAddress(r io.Reader) (*pb.Person, error) {
	...
	fmt.Print("Enter persons Id Number : ")
	...
	for {
		fmt.Print("Enter a phone number (or type done to finish): ")
		phone, err := rd.ReadString('\n')
		if err != nil {
			return p, err
		}
		if strings.TrimSpace(phone) == "done" {
			break
		}
		...
		fmt.Print("Is this a mobile, work or home phone? ")
